	...
	\begin{leftcolumn}
		...
		\cvtitle{Michail Anargyros\\Zamagias}{
			\parbox{\mpwidth}{
				...
				I am an undergraduate student in Informatics Engineering at TEI of Crete, nearing the completion of my degree. I have a strong foundation in software development, particularly in Flutter and Firebase as I have been working with them for the past three years.\\[0.3cm]
				As a Software Engineering Intern at TEI of Crete, I architected and developed the \textit{Healpen} application, a project that aids users in expressing their thoughts and emotions. It enables the \textit{expressive writing method} and provides the users with insightful visualizations on their mood by performing sentiment analysis on their writing entries. This project not only honed my technical skills but also demonstrated my ability to manage a complete software lifecycle from conception to deployment.\\[0.3cm]
		...
		\cvskill{Frameworks}{Anaconda, Flutter, Nuxt3, TailwindCSS, GitHub Actions}{2020}
