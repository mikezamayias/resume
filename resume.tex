...
\begin{paracol}{2}
  ...
  \begin{rightcolumn}
    ...
    {Dart, Flutter}
    {Ιστοσελίδα (διαδικτυακού εμπορίου). Το frontend είναι κατασκευασμένο με Flutter και το backend με Firebase.}
    {Το project είναι μερικώς ολοκληρωμένο και ανενεργό, αλλά η ιστοσελίδα είναι διαθέσιμη \href{https://flutter-ecommerce-website-demo.web.app/}{εδώ}.}
    \cvevent
    {\textbf{2021}}
    {\href{https://github.com/mzamayias/qrapp}{qrapp}}
    {Dart, Flutter}
    {Android και iOS εφαρμογή. Η εφαρμογή προσφέρει ανάγνωση και δημιουργία QR κωδικών και το ιστορικό αυτών.}
    {Το project δεν είναι ολοκληρωμένο και η εφαρμογή δεν είναι διαθέσιμη στο διαδίκτυο.}
    \cvevent
    {\textbf{2020}}
