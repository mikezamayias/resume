...
\begin{paracol}{2}
  \begin{leftcolumn}
    \vspace*{0.42cm}
    \cvtitle{Μιχάλης \\ Ζαμάγιας}{Προπτυχιακός Σπουδαστής}
    \vfill\null
    \selfie
    \vfill\null
  ...
  \begin{rightcolumn}
    ...
    {Dart, Flutter}
    {Ιστοσελίδα e-shop για κινητά. Το frontend είναι κατασκευασμένο με Flutter και το backend με Firebase.}
    {Το project είναι ανενεργό και μερικώς ολοκληρωμένο, αλλά η ιστοσελίδα είναι διαθέσιμη \href{https://flutter-ecommerce-website-demo.web.app/}{εδώ}.}
    \cvevent
    {\textbf{2021}}
    {\href{https://github.com/mzamayias/qrapp}{qrapp}}
    {Dart, Flutter}
    {Android και iOS εφαρμογή για ανάγνωση και δημιουργία QR κωδικών και το ιστορικό αυτών.}
    {Το project είναι ανενεργό και δεν είναι ολοκληρωμένο. Η εφαρμογή δεν είναι διαθέσιμη στο διαδίκτυο.}
    \cvevent
    {\textbf{2020}}
    ...
    {Dart, Flutter}
    {Android και iOS εφαρμογή για οπτικοποίηση δεδομένων ύπνου, καρδιακού παλμού, βημάτων και θερμίδων από fitness tracker.}
    {Το project είναι ανενεργό και δεν είναι ολοκληρωμένο. Η εφαρμογή δεν είναι διαθέσιμη στο διαδίκτυο.}
    \newpage
  \end{rightcolumn}
\end{paracol}
