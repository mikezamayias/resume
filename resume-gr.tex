...
\begin{paracol}{2}
	\begin{leftcolumn}
		...
		\cvskill{Anaconda}{3+ χρόνια}{0.6}
		\cvskill{Dart}{4+ χρόνια}{0.8}
		\cvskill{Flutter}{4+ χρόνια}{0.8}
		\cvskill{JS/TS, HTML, CSS}{1+ χρόνια}{0.1}
		\cvskill{Web Development}{1+ χρόνια}{0.1}
		\cvskill{UI Design}{1+ χρόνια}{0.1}
		% \vfill\null
		% \cvsection{Γλώσσες}
	...
	\begin{rightcolumn}
		...
		\vfill\null
		\cvsection{Εξωτερικές Δραστηριότητες}
		\cvevent
		{\textbf{2018 - παρών}}
		{Σώμα Ελληνικού Οδηγισμού}
		{Ηράκλειο, Ελλάδα}
		{Αρχηγός, Υπαρχηγός και Βοηθός Ομάδας}
		{}
		\vfill\null
		...
		{}
		\newpage
		\cvsection{Προσωπική Εργασία}
		\cvevent
		{\textbf{2022}}
		{\href{https://github.com/mzamayias/personal-website}{personal-website}}
		{Nuxt3}
		{Το \href{https://www.mikezamayias.com/}{portofolio} μου.}
		{}
		\cvevent
		{\textbf{2021}}
